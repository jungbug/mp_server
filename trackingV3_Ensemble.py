...
# #target_image_name='test2.png'
# #target_image_name='uploaded_images'
...
def process_frame_with_ai(frame):
    ...
    # target_image_name='test.png'
    # img=cv2.imread(target_image_name)[...,:3]
    # target_img=detect_person(img)[0]
    # target_image_name2='test2.png'
    # img2=cv2.imread(target_image_name2)[...,:3]
    #target_img2=detect_person(img2)[0]
    
    # target_images = [target_img, target_img2]
...
# 각 객체(ID)의 하위 10퍼의 값을 기준으로 이보다 작은 값들의 평균이 simthreshold 이하이면
# 그 ID는 candidates에 유사도를 저장해줌
